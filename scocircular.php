...
if(isset($_POST['submit'])){
    $sql = "INSERT INTO cocircular (name,rollno,year,branch,eventname,conductingclg,orgname,dates,ie,academicyear,file) VALUES ('$name','$rollno','$year','$branch','$nevent','$condclg','$conorg','$dates','$ie','$ay','$filename')";
    // Execute query
