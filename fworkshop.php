...
if(isset($_POST['submit'])){
    $sql = "INSERT INTO fworkshop (name,id,department,workshopn,org,place,startdate,enddate,duration,file) VALUES ('$name','$id','$department','$wn','$org','$place','$sd','$ed','$durt','$filename')";
    // Execute query
