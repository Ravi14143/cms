...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="search for Name of Certificate.." title="Type in a name">
	...
	<div class="container">
      ...
      <table id="myTable">
        ...
        $query="SELECT * FROM sworkshop WHERE Rollno='$rollno'";
      ...
      <table id="myTable">
				...
				<?php
				 $query="SELECT * FROM sinternship WHERE rollno='$rollno'";
				 $result=mysqli_query($conn,$query);
				  while($rows=mysqli_fetch_assoc($result))
				  {
				?>
      ...
      <table id="myTable">
				...
				<?php
				 $query="SELECT * FROM sproject WHERE Roll_Number='$rollno'";
				 $result=mysqli_query($conn,$query);
				  while($rows=mysqli_fetch_assoc($result))
				  {
				?>
      ...
      <table id="myTable">
				...
				<?php
				 $query="SELECT * FROM course WHERE RollNo='$rollno'";
				 $result=mysqli_query($conn,$query);
				  while($rows=mysqli_fetch_assoc($result))
				  {
				?>
...
<h1>Extra Circular</h1>
      ...
      <table id="myTable">
				...
				<?php
				 $query="SELECT * FROM extracircular WHERE rollno='$rollno'";
				 $result=mysqli_query($conn,$query);
				  while($rows=mysqli_fetch_assoc($result))
				  {
				?>
...
<h1>Co Circular</h1>
      ...
      <table id="myTable">
				...
				<?php
				 $query="SELECT * FROM cocircular WHERE rollno='$rollno'";
				 $result=mysqli_query($conn,$query);
				  while($rows=mysqli_fetch_assoc($result))
				  {
				?>
